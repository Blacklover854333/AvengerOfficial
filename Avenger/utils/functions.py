...
from Avenger.ex_plugins.dbfunctions import start_restart_stage
...
async def restart(m: Message):
    ...
    execvp(executable, [executable, "-m", "Avenger"])
...
def generate_captcha():
    ...
    height = 100
    correct_answer = ""
    font = ImageFont.truetype("Avenger/resources/default.ttf", 55)
    file = f"Avenger/resources/{randint(1000, 9999)}.jpg"
